...
All of the data related to loot chests is saved in data storage. This means that the data can be easily read from or edited in-game (as opposed to being hardcoded in a 
function). Most of the tools in this datapack are related to creating or modifying this chest data, such as spawn positions, spawn probability, or loot quality. 
...
Player's inventory will be cleared, then filled with random loot generated from 5 common, 
0 uncommon, 1 rare, 1 epic, and 2 cornucopia chests.
``` 
