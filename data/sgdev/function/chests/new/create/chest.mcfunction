...
$data modify storage sg:chests Chunks[$(ChunkIndex)].Chests append value {xyz:"$(xyz)",Quality:"$(Quality)",PlacedBy:"$(PlacedBy)",SpawnChance:$(SpawnChance)d,Facing:"$(Facing)",Color:$(Color)}
