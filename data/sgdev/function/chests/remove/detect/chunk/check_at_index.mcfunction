...
execute unless score #Success sgdev.array matches 0 unless score $ChunkIndex sgdev.array matches ..-1 run function sgdev:chests/remove/detect/chunk/check_at_index with storage sgdev:array
