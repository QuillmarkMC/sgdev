...
execute as @a[scores={sgdev.items=1..}] run function sgdev:chests/item/give with entity @s
...
execute as @a[scores={sgdev.loot=1..}] at @s run function sgdev:demo/loot/start
...
scoreboard players enable @a sgdev.items
...
scoreboard players enable @a sgdev.loot
